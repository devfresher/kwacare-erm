...
<head>
	...
	<!-- Page Title -->
	<title>KwaCare - Kwara State ERM</title>
	<!-- Favicon Icon -->
	<link rel="icon" href="assets/img/KwaCare.png" />
	<!-- Stylesheets -->
...
<body>
	<div class="st-perloader">
		<div class="st-perloader-in">
			<div class="st-wave-first">
				<img src="assets/img/KWC_2.gif" alt="">
			</div>
				...
				<div class="st-top-header-in">
					<ul class="st-top-header-list">
						...
						<li>
							...
							<a href="#">+234 - 801 5567 890</a>
						</li>
					</ul>
					<a href="https://dulcet-liger-f90632.netlify.app/" class="st-top-header-btn st-smooth-move">Sign up</a>
				</div>
			</div>
		</div>
				...
				<div class="st-main-header-in">
					<div class="st-main-header-left">
						<a class="st-site-branding" href="index.html">
							<img src="assets/img/KwaCare_1.svg" alt="KwaCare">
						</a>
					</div>
					<div class="st-main-header-right">
						<div class="st-nav">
							<ul class="st-nav-list st-onepage-nav">
								<li><a href="index.php?site=default" class="st-smooth-move">Home</a></li>
								<li><a href="#about" class="st-smooth-move">About</a></li>
								<li><a href="#health-cares" class="st-smooth-move">Health Providers</a></li>
	...
	<div class="st-content">
		...
		<!-- Start Hero Seciton -->
		<div class="st-hero st-style1 st-dynamic-bg st-bg st-fixed-bg" data-src="assets/img/home-bg.jpg">
			<div class="container">
				<div class="st-hero-text st-style1 text-center">
					<h1 class="st-hero-title cd-headline clip cd-headline-style1">
						Get Quality Treatment <br>
						<span class="cd-words-wrapper" style="font-size: 65px;">
							<b class="is-visible">Appointment schedule</b>
							<b>Secured data storage</b>
							<b>Effective prescription</b>
						</span>
					</h1>
					<div class="st-hero-subtitle">
						A digital platform for Kwara State indigenes and residents to access their medical records,
						schedule appointments, access prescription forms, view lab test results, manage billing and payments,
						and streamline transactions across all departments.
					</div>
					<div class="st-hero-btn-group">
						<a href="#health-care" class="st-btn st-style1 st-size-medium st-color1 st-smooth-move">Register to receive care</a>
						<a href="#about" class="st-btn st-style1 st-size-medium st-color2 st-smooth-move">Register as a healthcare provider</a>
						<a href="#about" class="st-btn st-style1 st-size-medium st-color1 st-smooth-move">Register as a Healthcare Facility</a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
							...
							<div class="st-iconbox-icon st-green-box">
								<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<g id="SVGRepo_iconCarrier">
										...
										<path opacity="0.4" d="M3.5 9.08984H20.5" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
										<path d="M19.21 15.7698L15.6701 19.3098C15.5301 19.4498 15.4 19.7098 15.37 19.8998L15.18 21.2498C15.11 21.7398 15.45 22.0798 15.94 22.0098L17.29 21.8198C17.48 21.7898 17.75 21.6598 17.88 21.5198L21.4201 17.9798C22.0301 17.3698 22.3201 16.6598 21.4201 15.7598C20.5301 14.8698 19.82 15.1598 19.21 15.7698Z" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
										<path d="M18.7002 16.2798C19.0002 17.3598 19.8402 18.1998 20.9202 18.4998" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
										<path d="M12 22H8C4.5 22 3 20 3 17V8.5C3 5.5 4.5 3.5 8 3.5H16C19.5 3.5 21 5.5 21 8.5V12" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
										<path opacity="0.4" d="M11.9955 13.7002H12.0045" stroke="#292D32" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
										<path opacity="0.4" d="M8.29431 13.7002H8.30329" stroke="#292D32" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
										<path opacity="0.4" d="M8.29492 16.7002H8.3039" stroke="#292D32" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
									</g>
								</svg>
							</div>
							<h2 class="st-iconbox-title">Appointment Schedule</h2>
							<div class="st-iconbox-text">Easily schedule your next appointment with our online scheduling system, available 24/7 for your convenience.</div>
						</div>
					...
					<div class="col-lg-3">
						<div class="st-iconbox st-style1">
							...
							<h2 class="st-iconbox-title">Prescription form</h2>
							<div class="st-iconbox-text">Complete our online prescription form to request medication refills or new prescriptions from your healthcare provider.</div>
						</div>
						<div class="st-height-b0 st-height-lg-b30"></div>
					</div><!-- .col -->
					<div class="col-lg-3">
						<div class="st-iconbox st-style1">
							<div class="st-iconbox-icon st-green-box">
								<svg fill="#000000" viewBox="0 0 32 32" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:serif="http://www.serif.com/" xmlns:xlink="http://www.w3.org/1999/xlink">
									<g id="SVGRepo_bgCarrier" stroke-width="0"></g>
									<g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
									<g id="SVGRepo_iconCarrier">
							...
							<h2 class="st-iconbox-title">Billing and payment</h2>
							<div class="st-iconbox-text">Easily manage your healthcare bills and make payments securely online through our patient portal.</div>
						</div>
						<div class="st-height-b0 st-height-lg-b30"></div>
					</div><!-- .col -->
					<div class="col-lg-3">
						<div class="st-iconbox st-style1">
							<div class="st-iconbox-icon st-green-box">
								<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000">
									...
									<g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
									<g id="SVGRepo_iconCarrier">
										<path d="M14 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22" stroke="#002D4D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
										<path d="M22 10V13" stroke="#002D4D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
										<path d="M22 10H18C15 10 14 9 14 6V2L22 10Z" stroke="#002D4D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
										<path opacity="0.4" d="M13.7605 18.2598C11.4105 18.4298 11.4105 21.8298 13.7605 21.9998H19.3205C19.9905 21.9998 20.6505 21.7498 21.1405 21.2998C22.7905 19.8598 21.9105 16.9798 19.7405 16.7098C18.9605 12.0198 12.1805 13.7998 13.7805 18.2698" stroke="#002D4D" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
									</g>
								</svg>
							</div>
							<h2 class="st-iconbox-title">Secure and centralized storage</h2>
							<div class="st-iconbox-text">Rest easy knowing that your sensitive medical information is securely stored and easily accessible through our centralized electronic medical record system.</div>
						</div>
						<div class="st-height-b0 st-height-lg-b30"></div>
					</div>
				</div>
		...
		<section class="st-about-wrap" id="about">
			...
			<div class="container">
				<div class="st-section-heading st-style1">
					...
					<div class="st-section-heading-subtitle">A platform that currently address the problem of inadequate medical record keeping in Kwara state government owned hospitals, which will thus improve patient outcomes, reduces medical errors and boost the kwara state economy. </div>
				</div>
						...
						<div class="st-vertical-middle">
							<div class="st-vertical-middle-in">
								<div class="st-text-block st-style1">
									<h2 class="st-text-block-title">A hospital is a health care institution providing patient treatment with specialized medical care</h2>
									<div class="st-height-b20 st-height-lg-b20"></div>
									<div class="st-text-block-text">
										<p>
											Comprehensive digital medical record keeping and documentation platform that offers
											all time access baseline transformation to a frictionless healthcare system in
											Kwara State.
										</p>
										<p>
											KwaCare is Bridging the gap between the healthcare providers, patients and agencies,
											leading a revolution for the creation and implementation of smart polices and impactful
											discoveries.
										</p>
									</div>
							...
							<div class="st-shedule">
								...
								<div class="st-call st-style1">
									...
									<div class="st-call-text">
										...
										<div class="st-call-number">(+234) - 801 5567 890</div>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- Start Team Section -->
		<section id="health-cares">
			<div class="st-height-b120 st-height-lg-b80"></div>
			<div class="container">
				<div class="st-section-heading st-style1">
					<h2 class="st-section-heading-title">Health Facilities and Providers</h2>
					<div class="st-seperator">
						<div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
						<div class="st-seperator-center"><img src="assets/img/icons/4.png" alt="icon"></div>
						<div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"></div>
					</div>
					<div class="st-section-heading-subtitle">Our health centers and providers are dedicated to providing high-quality, comprehensive care to patients of all ages and backgrounds. From primary care to specialized services, our team of experienced medical professionals are here to support you on your journey to optimal health.</div>
				</div>
				<div class="st-height-b40 st-height-lg-b40"></div>
			</div>
			<div class="container">
				...
				<div class="row">
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="st-funfact st-style1">
									...
									<h2 class="st-funfact-number st-counter">2</h2>
									<div class="st-funfact-title">Health Facilities</div>
								</div>
							...
							<div class="col-lg-6">
								<div class="st-funfact st-style1">
									...
									<div class="st-funfact-title">Registered Patients</div>
								</div>
								<div class="st-height-b30 st-height-lg-b30"></div>
							</div><!-- .col -->
							<div class="col-lg-6">
								<div class="st-funfact st-style1">
									...
									<div class="st-funfact-title">Qualified Health Care Providers</div>
								</div>
								<div class="st-height-b30 st-height-lg-b30"></div>
							</div><!-- .col -->
							<!-- <div class="col-lg-6">
					...
					<div class="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
						<div class="st-video-block st-style1 st-zoom">
							<div class="st-video-block-img st-zoom-in st-dynamic-bg" style="background-position: left center; background-size: contain" data-src="assets/img/kwacare-bill.png"></div>
							<!-- <a href="" class="st-play-btn st-style1 st-video-open">
					...
					<div class="col-lg-6">
						...
						<div class="st-accordian-wrap">
							<div class="st-accordian active ">
								...
								<div class="st-accordian-body">KwaraCare is a digital hub for Kwara State indigene and residents to have access to their medical health records, appointment scheduling,prescription form, Laboratory test results, billings and payment which facilitates one time transactions in all departments.</div>
							</div><!-- .st-accordian -->
							<div class="st-accordian">
								...
								<div class="st-accordian-body">
									To refill your prescription, simply log into your account on our website and select the
									"Refill Prescription" button.
									You can also call our pharmacy directly and one of our friendly staff members will assist you in processing your refill.
								</div>
							</div><!-- .st-accordian -->
							<div class="st-accordian">
								<div class="st-accordian-title">
									How competent is our total treatment?
									<span class="st-accordian-toggle fa fa-angle-down"></span>
								</div>
								<div class="st-accordian-body">Our experienced team of healthcare professionals and state-of-the-art technology ensures the highest level of competence in every aspect of patient treatment.</div>
							</div><!-- .st-accordian -->
							<div class="st-accordian">
								<div class="st-accordian-title">
								...
								<div class="st-accordian-body">
									If you experience symptoms of illness, it is recommended to reach out to a healthcare provider
									for proper evaluation and treatment. It is important to take necessary precautions and seek medical
									attention as soon as possible to prevent further complications and ensure a timely recovery.
								</div>
							</div><!-- .st-accordian -->
							<div class="st-accordian">
								<div class="st-accordian-title">
									What is KwaCare's emergency line?
									<span class="st-accordian-toggle fa fa-angle-down"></span>
								</div>
								<div class="st-accordian-body">The emergency line to KwaCare is +234 - 801 5567 890</div>
							</div><!-- .st-accordian -->
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="st-news-letter">
							...
							<div class="st-news-letter-number">(+234) - 801 5567 890</div>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="st-shape-wrap" id="contact">
			...
			<div class="container">
				<div class="st-section-heading st-style1">
					<h2 class="st-section-heading-title">Stay connected with us</h2>
					<div class="st-seperator">
						<div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
						<div class="st-seperator-center"><img src="assets/img/icons/4.png" alt="icon"></div>
						<div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"></div>
					</div>
					<div class="st-section-heading-subtitle">We're here to support you on your health journey, and we're always happy to hear from you.<br> Contact us with any questions or comments, and we'll be happy to help. Stay connected with us and take control of your health today!</div>
				</div>
				<div class="st-height-b40 st-height-lg-b40"></div>
			</div>
			<div class="container">
						...
						<div class="st-footer-widget">
							<div class="st-text-field">
								<a href="#" class="logo-footer">
									<img src="assets/img/KwaCare_1.svg" alt="">
								</a>
								<!-- <img src="assets/img/KwaCare.png" alt="Nischinto" class="st-footer-logo"> -->
								<div class="st-height-b25 st-height-lg-b25"></div>
								<div class="st-footer-text">Digital hub for Kwara State indigene and residents to have access to their medical health records, appointment scheduling,prescription form, Laboratory test results, billings and payment which facilitates one time transactions in all departments.</div>
								<div class="st-height-b25 st-height-lg-b25"></div>
					...
					<div class="col-lg-3">
						<div class="st-footer-widget">
							...
							<ul class="st-footer-contact-list st-mp0">
								<li><span class="st-footer-contact-title">Email:</span> info@kwacare.com.ng</li>
								<li><span class="st-footer-contact-title">Phone:</span> (+234) - 801 5567 890<br>(+234) - 345 678 901</li>
							</ul>
						</div>
					</div><!-- .col -->
				</div>
			...
			<div class="container">
				<div class="st-copyright-in">
					<div class="st-left-copyright">
						<div class="st-copyright-text">Copyright <?php echo date('Y') ?>. Developed by devFresher</div>
					</div>
			...
			<div class="st-video-popup-container">
				<div class="st-video-popup-align">
					<div class="embed-responsive embed-responsive-16by9">
						<iframe class="embed-responsive-item" src="assets/img/kwacare.mp4">
							<video src="">
								<source src="assets/img/kwacare.mp4" type="video/mp4">
							</video>
						</iframe>
					</div>
				</div>
